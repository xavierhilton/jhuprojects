...
"""
The purpose of this script is to generate the visualization seen in Figure 3.
"""
...
years = ["1974","2001"]
metrics = ["CU_ICP40", "LA_ICP40", "HO_ICP40", "CE_ICP40", "YB_ICP40", "Y_ICP40", "CO_ICP40", "ZN_ICP40", "CR_ICP40"]
...
data = dict(site_year = sites_years, CU_ICP40 = wt_overall[0], LA_ICP40 = wt_overall[1], HO_ICP40 = wt_overall[2],
            CE_ICP40 = wt_overall[3], YB_ICP40 = wt_overall[4], Y_ICP40 = wt_overall[5], CO_ICP40 = wt_overall[6],
            ZN_ICP40 = wt_overall[7], CR_ICP40 = wt_overall[8])
data_cds = ColumnDataSource(data)
plot = figure(x_range = FactorRange(*sites_years), toolbar_location = None, width = 1100,
              title = "ICP40 Metric Comparisons Between Calista, SWAK2001 Datasets")
